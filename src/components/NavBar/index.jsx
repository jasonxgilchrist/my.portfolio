        ...
        <div className="list-wrapper">
          ...
          <ul style={{ left: open ? "0" : "-100vw" }}>
            <li>
              <Link
                onClick={handleClose}
                style={{ color: location.pathname === "/" && "#cc3300" }}
                to="/"
              >
                Home
              </Link>
            ...
            <li>
              <Link
                onClick={handleClose}
                style={{ color: location.pathname === "/about" && "#cc3300" }}
                to="/about"
              >
                About
              </Link>
            ...
            <li>
              <Link
                onClick={handleClose}
                style={{ color: location.pathname === "/skills" && "#cc3300" }}
                to="/skills"
              >
                Skills
              </Link>
            ...
            <li>
              <Link
                onClick={handleClose}
                style={{ color: location.pathname === "/works" && "#cc3300" }}
                to="/works"
              >
                Works
              </Link>
            ...
            <li>
              <Link
                onClick={handleClose}
                style={{ color: location.pathname === "/contact" && "#cc3300" }}
                to="/contact"
              >
                Contact
              </Link>
